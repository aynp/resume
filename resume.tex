...
\begin{itemize}
	\item Built CI pipelines for automatic building, linting, testing and deploying of 10 microservices.
\end{itemize}
\vspace{1.5mm}
...
\begin{itemize}
  \item Created an API for Problems List, Single Problem, Solutions, Leaderboard etc.
